...
![](attachments/Pasted%20image%2020241111171016.png)


#### 分析

可以看到中断都是被 CPU10 处理的。查看 mellanox 的资料 [what-is-irq-affinity-x](https://community.mellanox.com/s/article/what-is-irq-affinity-x)。也就是说这里配置了 10-19,30-39，但是只有 CPU10 在处理中断。
