...
```
![](attachments/Pasted%20image%2020230731192427.png)
## PCI架构图
![](attachments/Pasted%20image%2020230801233210.png)
...
![](attachments/Pasted%20image%2020230731205139.png)
...
![](attachments/Pasted%20image%2020230731205450.png)
...
![](attachments/Pasted%20image%2020230731212521.png)

## PCI总线的三种传输模式
PCI Spec规定的三种数据传输模型：Programmed I/O（PIO），Peer-to-Peer和DMA。
三种数据传输模型的示意图如下图所示：
![](attachments/Pasted%20image%2020230731212657.png)
**Programmed I/O（PIO）**
...
- Physical Layer （物理层）
![](attachments/Pasted%20image%2020230731205829.png)
...
![](attachments/Pasted%20image%2020230731210621.png)
...
![](attachments/Pasted%20image%2020230731210436.png)
...
![](attachments/Pasted%20image%2020230731211112.png)
...
### TLP传输
TLP传输的示意图如下图所示：
![](attachments/Pasted%20image%2020230731211401.png)
TLP在整个PCIe包结构的位置如以下两张图所示：（第一张为发送端，第二张为接收端）
![](attachments/Pasted%20image%2020230731211438.png)
![](attachments/Pasted%20image%2020230731211501.png)

其中，TLP包的结构图如下图所示：
![](attachments/Pasted%20image%2020230731211541.png)
...
具体如下图所示：
![](attachments/Pasted%20image%2020230731171630.png)
...
![](attachments/Pasted%20image%2020230731172200.png)
...
![](attachments/Pasted%20image%2020230731172607.png)

则有：
![](attachments/Pasted%20image%2020230731172614.png)

### PCIe的枚举Enumeration
![](attachments/Pasted%20image%2020230801123349.png)
...
![](attachments/Pasted%20image%2020230801124934.png)
...
![](attachments/Pasted%20image%2020230731173326.png)
...
![](attachments/Pasted%20image%2020230801153521.png)
...
![](attachments/Pasted%20image%2020230731183442.png)
![](attachments/Pasted%20image%2020230731183524.png)

### DDLP
Flow control过程需要两个层次的参与，Transaction Layer包含Counter和Data Link Layer产生FC DLLP给对端。

![](attachments/Pasted%20image%2020230731183838.png)
...
![](attachments/Pasted%20image%2020230731190841.png)

TLPOverhead为28B，包含STP(1B), Sequence(2B),TLP header(16B),ECRC(4B),TLP Prefix(4B), END(1B)

UF为UpdateFactor：
Gen1 （2.5GT/s）如下表所示：
![](attachments/Pasted%20image%2020230731191118.png)
Gen2（5GT/s）如下表所示：
![](attachments/Pasted%20image%2020230731191133.png)
Gen3 (8GT/s）如下表所示：
![](attachments/Pasted%20image%2020230731191144.png)
根据公式计算出的Max UpdateFC Latency计算结果如下:
![](attachments/Pasted%20image%2020230731191327.png)
...
![](attachments/Pasted%20image%2020230731184201.png)
...
![](attachments/Pasted%20image%2020230731184530.png)
...
![](attachments/Pasted%20image%2020230731220521.png)
...
![](attachments/Pasted%20image%2020230731220653.png)

两种DLLP（转发TLP的DLLP，用于Flow Control或Ack/Nak等的DLLP）的结构图分别如下图所示：
![](attachments/Pasted%20image%2020230731220714.png)
一个Non-Posted传输中，Ack/Nak的执行过程如下图所示：
![](attachments/Pasted%20image%2020230731220808.png)
...
![](attachments/Pasted%20image%2020230801145221.png)
![](attachments/Pasted%20image%2020230801145244.png)
...
![](attachments/Pasted%20image%2020230801150226.png)
...
![](attachments/Pasted%20image%2020230801150714.png)
表 3 显示了四种 MPS 设置的数据包效率计算。这些示例假设 TLP 具有 3 DW 或 12 字节标头并且没有 ECRC，从而产生总共 20 字节的开销。
![](attachments/Pasted%20image%2020230801150751.png)
...
![](attachments/Pasted%20image%2020230801151401.png)
