...
```
# 问题
如果 FIN 报文比数据包先抵达客户端，此时 FIN 报文其实是一个乱序的报文，此时客户端如何处理？
![](attachments/Pasted%20image%2020231113175259.png)
# 分析
...
![](attachments/Pasted%20image%2020231113175707.png)
